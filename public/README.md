...
- 実行結果データ: `data/runs/no_intervention_71steps_panel48/`, `data/runs/structure_intervention_100years_panel48_midprompt/`, `data/runs/policy_search_no_sustain_12steps_panel48/`, `data/runs/policy_search_with_sustain_12steps_panel48/`, `data/runs/birth_grant_only_83steps_panel48/`, `data/runs/structure_birth_grant_package_83steps_panel48/`, `data/runs/structure_hope_family_package_83steps_panel48/`
